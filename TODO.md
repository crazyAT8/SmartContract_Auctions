...
- [x] **Docker** – Verify `docker-compose` (DB, Redis, backend, frontend; optional `--profile local-chain`)
- [x] **Clarify README** – Document `frontend/` + Express as the primary app (root demo is legacy)
