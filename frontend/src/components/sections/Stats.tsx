    ...
    <section className="py-24 bg-white dark:bg-secondary-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div key={stat.name} className="text-center">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-primary-100 rounded-full dark:bg-primary-900/40">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center px-6 py-3 bg-primary-50 rounded-lg dark:bg-primary-900/30">
